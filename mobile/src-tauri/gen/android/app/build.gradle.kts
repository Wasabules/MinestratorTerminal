...
android {
    compileSdk = 36
    namespace = "com.geoffreylecoq.minestratorterminal"
    defaultConfig {
        manifestPlaceholders["usesCleartextTraffic"] = "false"
        applicationId = "com.geoffreylecoq.minestratorterminal"
        minSdk = 24
        targetSdk = 36
    ...
    buildTypes {
        ...
        getByName("release") {
            ...
            // Signe la release uniquement si le keystore est présent (CI). Sinon, non signée
            // (les tests locaux passent par `--debug`).
            if (keystorePropertiesFile.exists()) {
